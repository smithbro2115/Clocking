...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.resetClocksAfterExportingInvoicesCheckBox, 2, 0, 1, 2)
        self.amazonButtonsCheckBox = QtWidgets.QCheckBox(Dialog)
        self.amazonButtonsCheckBox.setObjectName("amazonButtonsCheckBox")
        self.gridLayout.addWidget(self.amazonButtonsCheckBox, 2, 2, 1, 1)
        ...
        self.emailTemplateSaveLocationLineEdit = QtWidgets.QLineEdit(self.frame_2)
        self.emailTemplateSaveLocationLineEdit.setObjectName("emailTemplateSaveLocationLineEdit")
        self.gridLayout_4.addWidget(self.emailTemplateSaveLocationLineEdit, 0, 0, 1, 1)
        self.browseEmailTemplateSaveLocationButton = QtWidgets.QToolButton(self.frame_2)
        self.browseEmailTemplateSaveLocationButton.setObjectName("browseEmailTemplateSaveLocationButton")
        self.gridLayout_4.addWidget(self.browseEmailTemplateSaveLocationButton, 0, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Email Template Save Location:"))
        self.browseEmailTemplateSaveLocationButton.setText(_translate("Dialog", "..."))
